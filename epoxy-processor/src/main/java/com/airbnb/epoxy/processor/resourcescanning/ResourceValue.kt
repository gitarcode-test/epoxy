...
class ResourceValue {
    ...
    val rClass: ClassName?
        get() = className?.topLevelClassName()
    ...
    constructor(className: ClassName, resourceName: String, value: Int) {
        ...
        this.value = value
        code =
            if (className.topLevelClassName() == ANDROID_R)
                CodeBlock.of("\$L.\$N", className, resourceName)
            else CodeBlock.of("\$T.\$N", className, resourceName)
        qualified = true
    }
