...
public class GroupPropMultipleSupportedAttributeDifferentNameModelViewModel_
    extends EpoxyModel<GroupPropMultipleSupportedAttributeDifferentNameModelView>
    implements GeneratedModel<GroupPropMultipleSupportedAttributeDifferentNameModelView>,
  ...
  /** Bitset index: 0 */
  @NonNull private String titleString_String;
  ...
  public void bind(
    ...
    if (!(previousModel
        instanceof GroupPropMultipleSupportedAttributeDifferentNameModelViewModel_)) {
      bind(object);
      return;
    }
    GroupPropMultipleSupportedAttributeDifferentNameModelViewModel_ that =
        (GroupPropMultipleSupportedAttributeDifferentNameModelViewModel_) previousModel;
    super.bind(object);

    if (assignedAttributes_epoxyGeneratedModel.get(0)) {
      if (!that.assignedAttributes_epoxyGeneratedModel.get(0)
          || (titleString_String != null
              ? !titleString_String.equals(that.titleString_String)
              : that.titleString_String != null)) {
        object.setTitleString(titleString_String);
      }
    } else if (assignedAttributes_epoxyGeneratedModel.get(1)) {
  ...
  @Override
  public void handlePostBind(
      final GroupPropMultipleSupportedAttributeDifferentNameModelView object, int position) {
  ...
  public void onVisibilityStateChanged(
      int visibilityState, final GroupPropMultipleSupportedAttributeDifferentNameModelView object) {
  ...
  public static GroupPropMultipleSupportedAttributeDifferentNameModelViewModel_ from(
    ...
    GroupPropMultipleSupportedAttributeDifferentNameModelViewModel_ model =
        new GroupPropMultipleSupportedAttributeDifferentNameModelViewModel_();
