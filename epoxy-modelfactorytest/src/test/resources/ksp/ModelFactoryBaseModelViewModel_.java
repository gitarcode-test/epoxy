...
public class ModelFactoryBaseModelViewModel_ extends EpoxyModel<ModelFactoryBaseModelView>
    implements GeneratedModel<ModelFactoryBaseModelView>, ModelFactoryBaseModelViewModelBuilder {
  private final BitSet assignedAttributes_epoxyGeneratedModel = new BitSet(1);

  private OnModelBoundListener<ModelFactoryBaseModelViewModel_, ModelFactoryBaseModelView>
      onModelBoundListener_epoxyGeneratedModel;

  private OnModelUnboundListener<ModelFactoryBaseModelViewModel_, ModelFactoryBaseModelView>
      onModelUnboundListener_epoxyGeneratedModel;

  private OnModelVisibilityStateChangedListener<
          ModelFactoryBaseModelViewModel_, ModelFactoryBaseModelView>
  ...
  public void handlePreBind(
      final EpoxyViewHolder holder, final ModelFactoryBaseModelView object, final int position) {
  ...
  public void onVisibilityStateChanged(
      int visibilityState, final ModelFactoryBaseModelView object) {
  ...
  public ModelFactoryBaseModelViewModel_ onVisibilityChanged(
      OnModelVisibilityChangedListener<ModelFactoryBaseModelViewModel_, ModelFactoryBaseModelView>
          listener) {
    onMutation();
  ...
  @Override
  public ModelFactoryBaseModelViewModel_ id(
