...
public class ListSubtypeModelViewModel_ extends EpoxyModel<ListSubtypeModelView>
    implements GeneratedModel<ListSubtypeModelView>, ListSubtypeModelViewModelBuilder {
  private final BitSet assignedAttributes_epoxyGeneratedModel = new BitSet(1);

  private OnModelBoundListener<ListSubtypeModelViewModel_, ListSubtypeModelView>
      onModelBoundListener_epoxyGeneratedModel;

  private OnModelUnboundListener<ListSubtypeModelViewModel_, ListSubtypeModelView>
      onModelUnboundListener_epoxyGeneratedModel;

  private OnModelVisibilityStateChangedListener<ListSubtypeModelViewModel_, ListSubtypeModelView>
      onModelVisibilityStateChangedListener_epoxyGeneratedModel;

  private OnModelVisibilityChangedListener<ListSubtypeModelViewModel_, ListSubtypeModelView>
      onModelVisibilityChangedListener_epoxyGeneratedModel;

  /** Bitset index: 0 */
  @NonNull private ArrayList<String> stringArrayList_ArrayList;
  ...
  public void handlePreBind(
      final EpoxyViewHolder holder, final ListSubtypeModelView object, final int position) {
  ...
  public void bind(final ListSubtypeModelView object, EpoxyModel previousModel) {
    ...
    if ((stringArrayList_ArrayList != null
        ? !stringArrayList_ArrayList.equals(that.stringArrayList_ArrayList)
        : that.stringArrayList_ArrayList != null)) {
      object.setStringArrayList(stringArrayList_ArrayList);
    }
  }
  ...
  public ListSubtypeModelViewModel_ onVisibilityStateChanged(
      OnModelVisibilityStateChangedListener<ListSubtypeModelViewModel_, ListSubtypeModelView>
          listener) {
    onMutation();
  ...
  public void onVisibilityChanged(
      ...
      int visibleHeight,
      int visibleWidth,
      final ListSubtypeModelView object) {
  ...
  @Override
  public ListSubtypeModelViewModel_ id(
  ...
  public int hashCode() {
    ...
    _result =
        31 * _result
            + (stringArrayList_ArrayList != null ? stringArrayList_ArrayList.hashCode() : 0);
    return _result;
  }
