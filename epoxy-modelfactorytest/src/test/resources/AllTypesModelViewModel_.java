...
public class AllTypesModelViewModel_ extends EpoxyModel<AllTypesModelView>
    implements GeneratedModel<AllTypesModelView>, AllTypesModelViewModelBuilder {
  private final BitSet assignedAttributes_epoxyGeneratedModel = new BitSet(15);

  private OnModelBoundListener<AllTypesModelViewModel_, AllTypesModelView>
      onModelBoundListener_epoxyGeneratedModel;

  private OnModelUnboundListener<AllTypesModelViewModel_, AllTypesModelView>
      onModelUnboundListener_epoxyGeneratedModel;

  private OnModelVisibilityStateChangedListener<AllTypesModelViewModel_, AllTypesModelView>
      onModelVisibilityStateChangedListener_epoxyGeneratedModel;

  private OnModelVisibilityChangedListener<AllTypesModelViewModel_, AllTypesModelView>
      onModelVisibilityChangedListener_epoxyGeneratedModel;

  private boolean booleanValue_Boolean = false;

  /** Bitset index: 1 */
  @NonNull private Boolean boxedBooleanValue_Boolean;

  /** Bitset index: 2 */
  @NonNull private CharSequence charSequenceValue_CharSequence;

  /** Bitset index: 3 */
  @NonNull private Double boxedDoubleValue_Double;

  private double doubleValue_Double = 0.0d;

  @DrawableRes private int drawableRes_Int = 0;

  /** Bitset index: 6 */
  @NonNull private List<? extends EpoxyModel<?>> epoxyModelList_List;

  private int intValue_Int = 0;

  /** Bitset index: 8 */
  @NonNull private Integer boxedIntValue_Integer;

  private long longValue_Long = 0L;

  /** Bitset index: 10 */
  @NonNull private Long boxedLongValue_Long;

  /** Bitset index: 11 */
  @NonNull private View.OnClickListener onClickListener_OnClickListener;

  @RawRes private int rawRes_Int = 0;

  /** Bitset index: 13 */
  @NonNull private String stringValue_String;

  /** Bitset index: 14 */
  @NonNull private List<String> stringList_List;
  ...
  public void handlePreBind(
      final EpoxyViewHolder holder, final AllTypesModelView object, final int position) {
  ...
  public void bind(final AllTypesModelView object, EpoxyModel previousModel) {
    ...
    if ((boxedIntValue_Integer != null
        ? !boxedIntValue_Integer.equals(that.boxedIntValue_Integer)
        : that.boxedIntValue_Integer != null)) {
      object.setBoxedIntValue(boxedIntValue_Integer);
    }

    if ((boxedBooleanValue_Boolean != null
        ? !boxedBooleanValue_Boolean.equals(that.boxedBooleanValue_Boolean)
        : that.boxedBooleanValue_Boolean != null)) {
      object.setBoxedBooleanValue(boxedBooleanValue_Boolean);
    }

    if ((boxedDoubleValue_Double != null
        ? !boxedDoubleValue_Double.equals(that.boxedDoubleValue_Double)
        : that.boxedDoubleValue_Double != null)) {
      object.setBoxedDoubleValue(boxedDoubleValue_Double);
    }

    if ((epoxyModelList_List != null
        ? !epoxyModelList_List.equals(that.epoxyModelList_List)
        : that.epoxyModelList_List != null)) {
      object.setEpoxyModelList(epoxyModelList_List);
    }

    if ((boxedLongValue_Long != null
        ? !boxedLongValue_Long.equals(that.boxedLongValue_Long)
        : that.boxedLongValue_Long != null)) {
      object.setBoxedLongValue(boxedLongValue_Long);
    }
    ...
    if ((stringList_List != null
        ? !stringList_List.equals(that.stringList_List)
        : that.stringList_List != null)) {
      object.setStringList(stringList_List);
    }
    ...
    if (((onClickListener_OnClickListener == null)
        != (that.onClickListener_OnClickListener == null))) {
      object.setOnClickListener(onClickListener_OnClickListener);
    }
    ...
    if ((charSequenceValue_CharSequence != null
        ? !charSequenceValue_CharSequence.equals(that.charSequenceValue_CharSequence)
        : that.charSequenceValue_CharSequence != null)) {
      object.setCharSequenceValue(charSequenceValue_CharSequence);
    }
  }
  ...
  public void onVisibilityChanged(
      ...
      int visibleHeight,
      int visibleWidth,
      final AllTypesModelView object) {
  ...
  public AllTypesModelViewModel_ onClickListener(
      @NonNull
          final OnModelClickListener<AllTypesModelViewModel_, AllTypesModelView> onClickListener) {
  ...
  @Override
  public AllTypesModelViewModel_ id(
  ...
  public int hashCode() {
    ...
    _result =
        31 * _result
            + (boxedBooleanValue_Boolean != null ? boxedBooleanValue_Boolean.hashCode() : 0);
    _result =
        31 * _result
            + (charSequenceValue_CharSequence != null
                ? charSequenceValue_CharSequence.hashCode()
                : 0);
    _result =
        31 * _result + (boxedDoubleValue_Double != null ? boxedDoubleValue_Double.hashCode() : 0);
  ...
  public String toString() {
    return "AllTypesModelViewModel_{"
        ...
        + booleanValue_Boolean
        + ", boxedBooleanValue_Boolean="
        + boxedBooleanValue_Boolean
        + ", charSequenceValue_CharSequence="
        + charSequenceValue_CharSequence
        + ", boxedDoubleValue_Double="
        + boxedDoubleValue_Double
        + ", doubleValue_Double="
        + doubleValue_Double
        + ", drawableRes_Int="
