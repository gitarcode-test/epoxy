...
public class TextPropModelViewModel_ extends EpoxyModel<TextPropModelView>
    implements GeneratedModel<TextPropModelView>, TextPropModelViewModelBuilder {
  private final BitSet assignedAttributes_epoxyGeneratedModel = new BitSet(1);

  private OnModelBoundListener<TextPropModelViewModel_, TextPropModelView>
      onModelBoundListener_epoxyGeneratedModel;

  private OnModelUnboundListener<TextPropModelViewModel_, TextPropModelView>
      onModelUnboundListener_epoxyGeneratedModel;

  private OnModelVisibilityStateChangedListener<TextPropModelViewModel_, TextPropModelView>
      onModelVisibilityStateChangedListener_epoxyGeneratedModel;

  private OnModelVisibilityChangedListener<TextPropModelViewModel_, TextPropModelView>
  ...
  public void handlePreBind(
      final EpoxyViewHolder holder, final TextPropModelView object, final int position) {
  ...
  public void onVisibilityChanged(
      ...
      int visibleHeight,
      int visibleWidth,
      final TextPropModelView object) {
   ...
   * @see TextPropModelView#setTitle(CharSequence)
   */
  public TextPropModelViewModel_ titleQuantityRes(
  ...
  @Override
  public TextPropModelViewModel_ id(
