...
public class GroupPropSingleSupportedAttributeModelViewModel_
    extends EpoxyModel<GroupPropSingleSupportedAttributeModelView>
    implements GeneratedModel<GroupPropSingleSupportedAttributeModelView>,
        GroupPropSingleSupportedAttributeModelViewModelBuilder {
  private final BitSet assignedAttributes_epoxyGeneratedModel = new BitSet(2);

  private OnModelBoundListener<
          GroupPropSingleSupportedAttributeModelViewModel_,
          GroupPropSingleSupportedAttributeModelView>
  ...
  /** Bitset index: 1 */
  @NonNull private Object title_Object;
  ...
  public void addTo(EpoxyController controller) {
    ...
    if (!assignedAttributes_epoxyGeneratedModel.get(0)
        && !assignedAttributes_epoxyGeneratedModel.get(1)) {
  ...
  @Override
  public void bind(
      final GroupPropSingleSupportedAttributeModelView object, EpoxyModel previousModel) {
    if (!(previousModel instanceof GroupPropSingleSupportedAttributeModelViewModel_)) {
      bind(object);
      return;
    }
    GroupPropSingleSupportedAttributeModelViewModel_ that =
        (GroupPropSingleSupportedAttributeModelViewModel_) previousModel;
    super.bind(object);
    ...
    if (assignedAttributes_epoxyGeneratedModel.get(0)) {
      ...
      if (!that.assignedAttributes_epoxyGeneratedModel.get(1)
          || (title_Object != null
              ? !title_Object.equals(that.title_Object)
              : that.title_Object != null)) {
        object.setTitle(title_Object);
      }
    }
  }
  ...
  public void handlePostBind(
      final GroupPropSingleSupportedAttributeModelView object, int position) {
  ...
  public void onVisibilityStateChanged(
      int visibilityState, final GroupPropSingleSupportedAttributeModelView object) {
  ...
  @Override
  public GroupPropSingleSupportedAttributeModelViewModel_ id(
  ...
  public static GroupPropSingleSupportedAttributeModelViewModel_ from(ModelProperties properties) {
    GroupPropSingleSupportedAttributeModelViewModel_ model =
        new GroupPropSingleSupportedAttributeModelViewModel_();
