...
public class OnViewRecycledViewModel_ extends EpoxyModel<OnViewRecycledView>
    implements GeneratedModel<OnViewRecycledView>, OnViewRecycledViewModelBuilder {
  private final BitSet assignedAttributes_epoxyGeneratedModel = new BitSet(1);

  private OnModelBoundListener<OnViewRecycledViewModel_, OnViewRecycledView>
      onModelBoundListener_epoxyGeneratedModel;

  private OnModelUnboundListener<OnViewRecycledViewModel_, OnViewRecycledView>
      onModelUnboundListener_epoxyGeneratedModel;

  private OnModelVisibilityStateChangedListener<OnViewRecycledViewModel_, OnViewRecycledView>
      onModelVisibilityStateChangedListener_epoxyGeneratedModel;

  private OnModelVisibilityChangedListener<OnViewRecycledViewModel_, OnViewRecycledView>
  ...
  public void handlePreBind(
      final EpoxyViewHolder holder, final OnViewRecycledView object, final int position) {
  ...
  public OnViewRecycledViewModel_ onVisibilityStateChanged(
      OnModelVisibilityStateChangedListener<OnViewRecycledViewModel_, OnViewRecycledView>
          listener) {
    onMutation();
  ...
  public void onVisibilityChanged(
      ...
      int visibleHeight,
      int visibleWidth,
      final OnViewRecycledView object) {
  ...
  @Override
  public OnViewRecycledViewModel_ id(
