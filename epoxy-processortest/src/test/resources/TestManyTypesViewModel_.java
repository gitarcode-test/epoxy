...
public class TestManyTypesViewModel_ extends EpoxyModel<TestManyTypesView>
  ...
  /** Bitset index: 2 */
  @NonNull private Function3<Integer, Integer, Integer, Integer> function_Function3;
  ...
  /** Bitset index: 8 */
  @NonNull private Integer integerValue_Integer;
  ...
  /** Bitset index: 11 */
  @NonNull private Boolean booleanValue_Boolean;

  /** Bitset index: 12 */
  @NonNull private String[] arrayValue_StringArray;

  /** Bitset index: 13 */
  @NonNull private List<String> listValue_List;

  /** Bitset index: 14 */
  @NonNull private Map<Integer, Integer> mapValue_Map;

  /** Bitset index: 15 */
  @NonNull private View.OnClickListener clickListener_OnClickListener;
  ...
  public void bind(final TestManyTypesView object, EpoxyModel previousModel) {
    ...
    if ((mapValue_Map != null
        ? !mapValue_Map.equals(that.mapValue_Map)
        : that.mapValue_Map != null)) {
      object.setMapValue(mapValue_Map);
    }
    ...
    if ((integerValue_Integer != null
        ? !integerValue_Integer.equals(that.integerValue_Integer)
        : that.integerValue_Integer != null)) {
      object.setIntegerValue(integerValue_Integer);
    }
