...
public class TestNullStringOverloadsViewModel_ extends EpoxyModel<TestNullStringOverloadsView>
    implements GeneratedModel<TestNullStringOverloadsView>,
        TestNullStringOverloadsViewModelBuilder {
  private OnModelBoundListener<TestNullStringOverloadsViewModel_, TestNullStringOverloadsView>
      onModelBoundListener_epoxyGeneratedModel;

  private OnModelUnboundListener<TestNullStringOverloadsViewModel_, TestNullStringOverloadsView>
      onModelUnboundListener_epoxyGeneratedModel;

  private OnModelVisibilityStateChangedListener<
          TestNullStringOverloadsViewModel_, TestNullStringOverloadsView>
  ...
  public void handlePreBind(
      final EpoxyViewHolder holder, final TestNullStringOverloadsView object, final int position) {
  ...
  public TestNullStringOverloadsViewModel_ onBind(
      OnModelBoundListener<TestNullStringOverloadsViewModel_, TestNullStringOverloadsView>
          listener) {
    onMutation();
  ...
  public TestNullStringOverloadsViewModel_ onUnbind(
      OnModelUnboundListener<TestNullStringOverloadsViewModel_, TestNullStringOverloadsView>
          listener) {
    onMutation();
  ...
  public void onVisibilityStateChanged(
      int visibilityState, final TestNullStringOverloadsView object) {
   ...
   * @see TestNullStringOverloadsView#setTitle(CharSequence)
   */
  public TestNullStringOverloadsViewModel_ titleQuantityRes(
  ...
  @Override
  public TestNullStringOverloadsViewModel_ id(
