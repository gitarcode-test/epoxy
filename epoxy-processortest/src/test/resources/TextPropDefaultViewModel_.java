...
public class TextPropDefaultViewModel_ extends EpoxyModel<TextPropDefaultView>
    implements GeneratedModel<TextPropDefaultView>, TextPropDefaultViewModelBuilder {
  private final BitSet assignedAttributes_epoxyGeneratedModel = new BitSet(2);

  private OnModelBoundListener<TextPropDefaultViewModel_, TextPropDefaultView>
      onModelBoundListener_epoxyGeneratedModel;

  private OnModelUnboundListener<TextPropDefaultViewModel_, TextPropDefaultView>
      onModelUnboundListener_epoxyGeneratedModel;

  private OnModelVisibilityStateChangedListener<TextPropDefaultViewModel_, TextPropDefaultView>
      onModelVisibilityStateChangedListener_epoxyGeneratedModel;

  private OnModelVisibilityChangedListener<TextPropDefaultViewModel_, TextPropDefaultView>
      onModelVisibilityChangedListener_epoxyGeneratedModel;

  /** Bitset index: 0 */
  private StringAttributeData textWithDefault_StringAttributeData =
      new StringAttributeData(R.string.string_resource_value);

  private StringAttributeData nullableTextWithDefault_StringAttributeData =
      new StringAttributeData(R.string.string_resource_value);
  ...
  public void handlePreBind(
      final EpoxyViewHolder holder, final TextPropDefaultView object, final int position) {
  ...
  public void bind(final TextPropDefaultView object) {
    ...
    object.nullableTextWithDefault(
        nullableTextWithDefault_StringAttributeData.toString(object.getContext()));
  }
  ...
  public void bind(final TextPropDefaultView object, EpoxyModel previousModel) {
    ...
    if ((textWithDefault_StringAttributeData != null
        ? !textWithDefault_StringAttributeData.equals(that.textWithDefault_StringAttributeData)
        : that.textWithDefault_StringAttributeData != null)) {
      object.textWithDefault(textWithDefault_StringAttributeData.toString(object.getContext()));
    }

    if ((nullableTextWithDefault_StringAttributeData != null
        ? !nullableTextWithDefault_StringAttributeData.equals(
            that.nullableTextWithDefault_StringAttributeData)
        : that.nullableTextWithDefault_StringAttributeData != null)) {
      object.nullableTextWithDefault(
          nullableTextWithDefault_StringAttributeData.toString(object.getContext()));
    }
  }
  ...
  public TextPropDefaultViewModel_ onVisibilityStateChanged(
      OnModelVisibilityStateChangedListener<TextPropDefaultViewModel_, TextPropDefaultView>
          listener) {
    onMutation();
  ...
  public void onVisibilityChanged(
      ...
      int visibleHeight,
      int visibleWidth,
      final TextPropDefaultView object) {
   ...
   * @see TextPropDefaultView#textWithDefault(CharSequence)
   */
  public TextPropDefaultViewModel_ textWithDefaultQuantityRes(
   ...
   *
   * <p><i>Optional</i>: Default value is R.string.string_resource_value
   *
   * @see TextPropDefaultView#nullableTextWithDefault(CharSequence)
   */
   ...
   * @see TextPropDefaultView#nullableTextWithDefault(CharSequence)
   */
  public TextPropDefaultViewModel_ nullableTextWithDefaultQuantityRes(
      @PluralsRes int pluralRes, int quantity, Object... formatArgs) {
    onMutation();
  ...
  @Override
  public TextPropDefaultViewModel_ id(
  ...
  public TextPropDefaultViewModel_ reset() {
    ...
    this.textWithDefault_StringAttributeData =
        new StringAttributeData(R.string.string_resource_value);
    this.nullableTextWithDefault_StringAttributeData =
        new StringAttributeData(R.string.string_resource_value);
    super.reset();
    return this;
  }
  ...
  public int hashCode() {
    ...
    _result =
        31 * _result
            + (textWithDefault_StringAttributeData != null
                ? textWithDefault_StringAttributeData.hashCode()
                : 0);
    _result =
        31 * _result
            + (nullableTextWithDefault_StringAttributeData != null
                ? nullableTextWithDefault_StringAttributeData.hashCode()
                : 0);
    return _result;
  }
  ...
  public String toString() {
    return "TextPropDefaultViewModel_{"
        + "textWithDefault_StringAttributeData="
        + textWithDefault_StringAttributeData
        + ", nullableTextWithDefault_StringAttributeData="
        + nullableTextWithDefault_StringAttributeData
        + "}"
        + super.toString();
  }
