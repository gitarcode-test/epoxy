...
public class ModelWithDataBindingBinding extends androidx.databinding.ViewDataBinding {
  ...
  public ModelWithDataBindingBinding(
      androidx.databinding.DataBindingComponent bindingComponent, View root) {
  ...
  public static ModelWithDataBindingBinding inflate(
  ...
  public static ModelWithDataBindingBinding inflate(
      ...
      androidx.databinding.DataBindingComponent bindingComponent) {
    return androidx.databinding.DataBindingUtil.<ModelWithDataBindingBinding>inflate(
        inflater,
        com.airbnb.epoxy.R.layout.model_with_data_binding,
        root,
        attachToRoot,
        bindingComponent);
  }
  ...
  public static ModelWithDataBindingBinding inflate(
      ...
      androidx.databinding.DataBindingComponent bindingComponent) {
    return bind(
        inflater.inflate(com.airbnb.epoxy.R.layout.model_with_data_binding, null, false),
        bindingComponent);
  }
  ...
  public static ModelWithDataBindingBinding bind(
      android.view.View view, androidx.databinding.DataBindingComponent bindingComponent) {
