...
public class TestAfterBindPropsViewModel_ extends EpoxyModel<TestAfterBindPropsView>
    implements GeneratedModel<TestAfterBindPropsView>, TestAfterBindPropsViewModelBuilder {
  private OnModelBoundListener<TestAfterBindPropsViewModel_, TestAfterBindPropsView>
      onModelBoundListener_epoxyGeneratedModel;

  private OnModelUnboundListener<TestAfterBindPropsViewModel_, TestAfterBindPropsView>
      onModelUnboundListener_epoxyGeneratedModel;

  private OnModelVisibilityStateChangedListener<
          TestAfterBindPropsViewModel_, TestAfterBindPropsView>
      onModelVisibilityStateChangedListener_epoxyGeneratedModel;

  private OnModelVisibilityChangedListener<TestAfterBindPropsViewModel_, TestAfterBindPropsView>
  ...
  public void handlePreBind(
      final EpoxyViewHolder holder, final TestAfterBindPropsView object, final int position) {
  ...
  public TestAfterBindPropsViewModel_ onVisibilityStateChanged(
      OnModelVisibilityStateChangedListener<TestAfterBindPropsViewModel_, TestAfterBindPropsView>
          listener) {
    onMutation();
  ...
  public void onVisibilityChanged(
      ...
      int visibleHeight,
      int visibleWidth,
      final TestAfterBindPropsView object) {
  ...
  public TestAfterBindPropsViewModel_ onVisibilityChanged(
      OnModelVisibilityChangedListener<TestAfterBindPropsViewModel_, TestAfterBindPropsView>
          listener) {
    onMutation();
  ...
  @Override
  public TestAfterBindPropsViewModel_ id(
