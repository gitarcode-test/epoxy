...
public class TestTextPropViewModel_ extends EpoxyModel<TestTextPropView>
    implements GeneratedModel<TestTextPropView>, TestTextPropViewModelBuilder {
  private final BitSet assignedAttributes_epoxyGeneratedModel = new BitSet(1);

  private OnModelBoundListener<TestTextPropViewModel_, TestTextPropView>
      onModelBoundListener_epoxyGeneratedModel;

  private OnModelUnboundListener<TestTextPropViewModel_, TestTextPropView>
      onModelUnboundListener_epoxyGeneratedModel;

  private OnModelVisibilityStateChangedListener<TestTextPropViewModel_, TestTextPropView>
      onModelVisibilityStateChangedListener_epoxyGeneratedModel;

  private OnModelVisibilityChangedListener<TestTextPropViewModel_, TestTextPropView>
  ...
  public void handlePreBind(
      final EpoxyViewHolder holder, final TestTextPropView object, final int position) {
   ...
   * @see TestTextPropView#setTitle(CharSequence)
   */
  public TestTextPropViewModel_ titleQuantityRes(
  ...
  @Override
  public TestTextPropViewModel_ id(
