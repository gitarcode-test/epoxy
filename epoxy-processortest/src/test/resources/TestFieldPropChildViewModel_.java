...
public class TestFieldPropChildViewModel_ extends EpoxyModel<TestFieldPropChildView>
    implements GeneratedModel<TestFieldPropChildView>, TestFieldPropChildViewModelBuilder {
  private final BitSet assignedAttributes_epoxyGeneratedModel = new BitSet(2);

  private OnModelBoundListener<TestFieldPropChildViewModel_, TestFieldPropChildView>
      onModelBoundListener_epoxyGeneratedModel;

  private OnModelUnboundListener<TestFieldPropChildViewModel_, TestFieldPropChildView>
      onModelUnboundListener_epoxyGeneratedModel;

  private OnModelVisibilityStateChangedListener<
          TestFieldPropChildViewModel_, TestFieldPropChildView>
      onModelVisibilityStateChangedListener_epoxyGeneratedModel;

  private OnModelVisibilityChangedListener<TestFieldPropChildViewModel_, TestFieldPropChildView>
  ...
  @Nullable private View.OnClickListener value_OnClickListener = (View.OnClickListener) null;
  ...
  public void handlePreBind(
      final EpoxyViewHolder holder, final TestFieldPropChildView object, final int position) {
  ...
  public void bind(final TestFieldPropChildView object, EpoxyModel previousModel) {
    ...
    if ((textValue_StringAttributeData != null
        ? !textValue_StringAttributeData.equals(that.textValue_StringAttributeData)
        : that.textValue_StringAttributeData != null)) {
      object.textValue = textValue_StringAttributeData.toString(object.getContext());
    }

    if ((value_OnClickListener != null
        ? !value_OnClickListener.equals(that.value_OnClickListener)
        : that.value_OnClickListener != null)) {
      object.value = value_OnClickListener;
    }
  }
  ...
  public TestFieldPropChildViewModel_ onVisibilityStateChanged(
      OnModelVisibilityStateChangedListener<TestFieldPropChildViewModel_, TestFieldPropChildView>
          listener) {
    onMutation();
  ...
  public void onVisibilityChanged(
      ...
      int visibleHeight,
      int visibleWidth,
      final TestFieldPropChildView object) {
  ...
  public TestFieldPropChildViewModel_ onVisibilityChanged(
      OnModelVisibilityChangedListener<TestFieldPropChildViewModel_, TestFieldPropChildView>
          listener) {
    onMutation();
   ...
   * @see TestFieldPropChildView#textValue
   */
  public TestFieldPropChildViewModel_ textValueQuantityRes(
  ...
  public TestFieldPropChildViewModel_ value(
      @Nullable
          final OnModelClickListener<TestFieldPropChildViewModel_, TestFieldPropChildView> value) {
    onMutation();
    if (value == null) {
  ...
  @Override
  public TestFieldPropChildViewModel_ id(
  ...
  public int hashCode() {
    ...
    _result =
        31 * _result
            + (textValue_StringAttributeData != null
                ? textValue_StringAttributeData.hashCode()
                : 0);
  ...
  public String toString() {
    return "TestFieldPropChildViewModel_{"
        + "textValue_StringAttributeData="
        + textValue_StringAttributeData
        + ", value_OnClickListener="
        + value_OnClickListener
        + "}"
        + super.toString();
  }
