...
public class PropDefaultsViewModel_ extends EpoxyModel<PropDefaultsView>
    implements GeneratedModel<PropDefaultsView>, PropDefaultsViewModelBuilder {
  private final BitSet assignedAttributes_epoxyGeneratedModel = new BitSet(6);

  private OnModelBoundListener<PropDefaultsViewModel_, PropDefaultsView>
      onModelBoundListener_epoxyGeneratedModel;

  private OnModelUnboundListener<PropDefaultsViewModel_, PropDefaultsView>
      onModelUnboundListener_epoxyGeneratedModel;

  private OnModelVisibilityStateChangedListener<PropDefaultsViewModel_, PropDefaultsView>
      onModelVisibilityStateChangedListener_epoxyGeneratedModel;

  private OnModelVisibilityChangedListener<PropDefaultsViewModel_, PropDefaultsView>
      onModelVisibilityChangedListener_epoxyGeneratedModel;

  @Nullable private CharSequence defaultsToNull_CharSequence = (CharSequence) null;

  /** Bitset index: 1 */
  @NonNull private CharSequence noDefaultSoItIsRequired_CharSequence;
  ...
  @NonNull private String objectWithDefault_String = PropDefaultsView.STRING_DEFAULT;

  @Nullable private String objectWithDefaultAndNullable_String = PropDefaultsView.STRING_DEFAULT;
  ...
  public void handlePreBind(
      final EpoxyViewHolder holder, final PropDefaultsView object, final int position) {
  ...
  public void bind(final PropDefaultsView object) {
    ...
    object.primitivesHaveImplicitDefaultsAndCannotBeRequired(
        primitivesHaveImplicitDefaultsAndCannotBeRequired_Int);
  }
  ...
  public void bind(final PropDefaultsView object, EpoxyModel previousModel) {
    ...
    if ((defaultsToNull_CharSequence != null
        ? !defaultsToNull_CharSequence.equals(that.defaultsToNull_CharSequence)
        : that.defaultsToNull_CharSequence != null)) {
      object.defaultsToNull(defaultsToNull_CharSequence);
    }

    if ((noDefaultSoItIsRequired_CharSequence != null
        ? !noDefaultSoItIsRequired_CharSequence.equals(that.noDefaultSoItIsRequired_CharSequence)
        : that.noDefaultSoItIsRequired_CharSequence != null)) {
      object.noDefaultSoItIsRequired(noDefaultSoItIsRequired_CharSequence);
    }

    if ((objectWithDefaultAndNullable_String != null
        ? !objectWithDefaultAndNullable_String.equals(that.objectWithDefaultAndNullable_String)
        : that.objectWithDefaultAndNullable_String != null)) {
      object.objectWithDefaultAndNullable(objectWithDefaultAndNullable_String);
    }

    if ((objectWithDefault_String != null
        ? !objectWithDefault_String.equals(that.objectWithDefault_String)
        : that.objectWithDefault_String != null)) {
      object.objectWithDefault(objectWithDefault_String);
    }

    if ((primitivesHaveImplicitDefaultsAndCannotBeRequired_Int
        != that.primitivesHaveImplicitDefaultsAndCannotBeRequired_Int)) {
      object.primitivesHaveImplicitDefaultsAndCannotBeRequired(
          primitivesHaveImplicitDefaultsAndCannotBeRequired_Int);
    }
  }
  ...
  @Override
  public PropDefaultsViewModel_ id(
  ...
  public int hashCode() {
    ...
    _result =
        31 * _result
            + (defaultsToNull_CharSequence != null ? defaultsToNull_CharSequence.hashCode() : 0);
    _result =
        31 * _result
            + (noDefaultSoItIsRequired_CharSequence != null
                ? noDefaultSoItIsRequired_CharSequence.hashCode()
                : 0);
    ...
    _result =
        31 * _result + (objectWithDefault_String != null ? objectWithDefault_String.hashCode() : 0);
    _result =
        31 * _result
            + (objectWithDefaultAndNullable_String != null
                ? objectWithDefaultAndNullable_String.hashCode()
                : 0);
    return _result;
  }
  ...
  public String toString() {
    return "PropDefaultsViewModel_{"
        + "defaultsToNull_CharSequence="
        + defaultsToNull_CharSequence
        + ", noDefaultSoItIsRequired_CharSequence="
        + noDefaultSoItIsRequired_CharSequence
        + ", primitivesHaveImplicitDefaultsAndCannotBeRequired_Int="
        + primitivesHaveImplicitDefaultsAndCannotBeRequired_Int
        + ", primitiveWithExplicitDefault_Int="
        + primitiveWithExplicitDefault_Int
        + ", objectWithDefault_String="
        + objectWithDefault_String
        + ", objectWithDefaultAndNullable_String="
        + objectWithDefaultAndNullable_String
        + "}"
        + super.toString();
  }
