...
public class RLayoutInViewModelAnnotationWorksViewModel_
    extends EpoxyModel<RLayoutInViewModelAnnotationWorksView>
    implements GeneratedModel<RLayoutInViewModelAnnotationWorksView>,
        RLayoutInViewModelAnnotationWorksViewModelBuilder {
  private OnModelBoundListener<
          RLayoutInViewModelAnnotationWorksViewModel_, RLayoutInViewModelAnnotationWorksView>
  ...
  public void bind(final RLayoutInViewModelAnnotationWorksView object, EpoxyModel previousModel) {
    ...
    RLayoutInViewModelAnnotationWorksViewModel_ that =
        (RLayoutInViewModelAnnotationWorksViewModel_) previousModel;
    super.bind(object);
  }
  ...
  public void onVisibilityStateChanged(
      int visibilityState, final RLayoutInViewModelAnnotationWorksView object) {
  ...
  @Override
  public RLayoutInViewModelAnnotationWorksViewModel_ id(
  ...
  public String toString() {
    return "RLayoutInViewModelAnnotationWorksViewModel_{" + "}" + super.toString();
  }
