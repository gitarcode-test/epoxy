...
public class DefaultPackageLayoutPatternViewModel_
    extends EpoxyModel<DefaultPackageLayoutPatternView>
    implements GeneratedModel<DefaultPackageLayoutPatternView>,
        DefaultPackageLayoutPatternViewModelBuilder {
  ...
  public void bind(final DefaultPackageLayoutPatternView object, EpoxyModel previousModel) {
    ...
    DefaultPackageLayoutPatternViewModel_ that =
        (DefaultPackageLayoutPatternViewModel_) previousModel;
    super.bind(object);
  }
  ...
  public DefaultPackageLayoutPatternViewModel_ onBind(
      OnModelBoundListener<DefaultPackageLayoutPatternViewModel_, DefaultPackageLayoutPatternView>
          listener) {
    onMutation();
  ...
  public DefaultPackageLayoutPatternViewModel_ onUnbind(
      OnModelUnboundListener<DefaultPackageLayoutPatternViewModel_, DefaultPackageLayoutPatternView>
          listener) {
    onMutation();
  ...
  public void onVisibilityStateChanged(
      int visibilityState, final DefaultPackageLayoutPatternView object) {
  ...
  @Override
  public DefaultPackageLayoutPatternViewModel_ id(
  ...
  public String toString() {
    return "DefaultPackageLayoutPatternViewModel_{" + "}" + super.toString();
  }
