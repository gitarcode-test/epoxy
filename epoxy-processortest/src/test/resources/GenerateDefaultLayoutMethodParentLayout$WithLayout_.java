...
public class GenerateDefaultLayoutMethodParentLayout$WithLayout_
    extends GenerateDefaultLayoutMethodParentLayout.WithLayout
    implements GeneratedModel<Object>, GenerateDefaultLayoutMethodParentLayout_WithLayoutBuilder {
  ...
  public GenerateDefaultLayoutMethodParentLayout$WithLayout_ onVisibilityChanged(
      OnModelVisibilityChangedListener<GenerateDefaultLayoutMethodParentLayout$WithLayout_, Object>
          listener) {
    onMutation();
  ...
  @Override
  public GenerateDefaultLayoutMethodParentLayout$WithLayout_ id(
  ...
  public String toString() {
    return "GenerateDefaultLayoutMethodParentLayout$WithLayout_{" + "}" + super.toString();
  }
}
