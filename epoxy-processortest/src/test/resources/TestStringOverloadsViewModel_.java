...
public class TestStringOverloadsViewModel_ extends EpoxyModel<TestStringOverloadsView>
    implements GeneratedModel<TestStringOverloadsView>, TestStringOverloadsViewModelBuilder {
  private final BitSet assignedAttributes_epoxyGeneratedModel = new BitSet(3);

  private OnModelBoundListener<TestStringOverloadsViewModel_, TestStringOverloadsView>
      onModelBoundListener_epoxyGeneratedModel;

  private OnModelUnboundListener<TestStringOverloadsViewModel_, TestStringOverloadsView>
  ...
  private OnModelVisibilityChangedListener<TestStringOverloadsViewModel_, TestStringOverloadsView>
  ...
  /** Bitset index: 1 */
  @Nullable private List<CharSequence> title_List = (List<CharSequence>) null;
  ...
  public void handlePreBind(
      final EpoxyViewHolder holder, final TestStringOverloadsView object, final int position) {
  ...
  public void bind(final TestStringOverloadsView object) {
    super.bind(object);
    object.setTitleViaValueShortcut(
        titleViaValueShortcut_StringAttributeData.toString(object.getContext()));
  ...
  public void bind(final TestStringOverloadsView object, EpoxyModel previousModel) {
    ...
    if ((titleViaValueShortcut_StringAttributeData != null
        ? !titleViaValueShortcut_StringAttributeData.equals(
            that.titleViaValueShortcut_StringAttributeData)
        : that.titleViaValueShortcut_StringAttributeData != null)) {
      object.setTitleViaValueShortcut(
          titleViaValueShortcut_StringAttributeData.toString(object.getContext()));
    }
    ...
    if (assignedAttributes_epoxyGeneratedModel.get(0)) {
      if (!that.assignedAttributes_epoxyGeneratedModel.get(0)
          || (title_StringAttributeData != null
              ? !title_StringAttributeData.equals(that.title_StringAttributeData)
              : that.title_StringAttributeData != null)) {
        object.setTitle(title_StringAttributeData.toString(object.getContext()));
      }
    } else if (assignedAttributes_epoxyGeneratedModel.get(1)) {
      if (!that.assignedAttributes_epoxyGeneratedModel.get(1)
          || (title_List != null ? !title_List.equals(that.title_List) : that.title_List != null)) {
        object.setTitle(title_List);
      }
    }
  ...
  public TestStringOverloadsViewModel_ onVisibilityStateChanged(
      OnModelVisibilityStateChangedListener<TestStringOverloadsViewModel_, TestStringOverloadsView>
          listener) {
    onMutation();
  ...
  public void onVisibilityChanged(
      ...
      int visibleHeight,
      int visibleWidth,
      final TestStringOverloadsView object) {
  ...
  public TestStringOverloadsViewModel_ onVisibilityChanged(
      OnModelVisibilityChangedListener<TestStringOverloadsViewModel_, TestStringOverloadsView>
          listener) {
    onMutation();
   ...
   * @see TestStringOverloadsView#setTitle(CharSequence)
   */
  public TestStringOverloadsViewModel_ titleQuantityRes(
   ...
   */
  public TestStringOverloadsViewModel_ titleViaValueShortcut(
      @StringRes int stringRes, Object... formatArgs) {
    onMutation();
    assignedAttributes_epoxyGeneratedModel.set(2);
   ...
   * @see TestStringOverloadsView#setTitleViaValueShortcut(CharSequence)
   */
  public TestStringOverloadsViewModel_ titleViaValueShortcutQuantityRes(
      @PluralsRes int pluralRes, int quantity, Object... formatArgs) {
    onMutation();
    assignedAttributes_epoxyGeneratedModel.set(2);
  ...
  @Override
  public TestStringOverloadsViewModel_ id(
  ...
  public int hashCode() {
    ...
    _result =
        31 * _result
            + (titleViaValueShortcut_StringAttributeData != null
                ? titleViaValueShortcut_StringAttributeData.hashCode()
                : 0);
    return _result;
  }
