...
public class ModelDoNotUseInToString_ extends ModelDoNotUseInToString
    implements GeneratedModel<Object>, ModelDoNotUseInToStringBuilder {
  private OnModelBoundListener<ModelDoNotUseInToString_, Object>
      onModelBoundListener_epoxyGeneratedModel;

  private OnModelUnboundListener<ModelDoNotUseInToString_, Object>
      onModelUnboundListener_epoxyGeneratedModel;

  private OnModelVisibilityStateChangedListener<ModelDoNotUseInToString_, Object>
      onModelVisibilityStateChangedListener_epoxyGeneratedModel;

  private OnModelVisibilityChangedListener<ModelDoNotUseInToString_, Object>
  ...
  @Override
  public ModelDoNotUseInToString_ id(
  ...
  public String toString() {
    return "ModelDoNotUseInToString_{" + "value=" + value + "}" + super.toString();
  }
}
