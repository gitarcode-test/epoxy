...
public class ModelWithoutSetter_ extends ModelWithoutSetter
    implements GeneratedModel<Object>, ModelWithoutSetterBuilder {
  ...
  private OnModelVisibilityStateChangedListener<ModelWithoutSetter_, Object>
      onModelVisibilityStateChangedListener_epoxyGeneratedModel;

  private OnModelVisibilityChangedListener<ModelWithoutSetter_, Object>
  ...
  public String toString() {
    return "ModelWithoutSetter_{" + "value=" + value + "}" + super.toString();
  }
}
