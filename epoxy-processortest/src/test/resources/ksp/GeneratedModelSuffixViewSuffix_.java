...
public class GeneratedModelSuffixViewSuffix_ extends EpoxyModel<GeneratedModelSuffixView>
    implements GeneratedModel<GeneratedModelSuffixView>, GeneratedModelSuffixViewSuffixBuilder {
  ...
  private OnModelUnboundListener<GeneratedModelSuffixViewSuffix_, GeneratedModelSuffixView>
  ...
  public void handlePreBind(
      final EpoxyViewHolder holder, final GeneratedModelSuffixView object, final int position) {
  ...
  public void onVisibilityChanged(
      ...
      int visibleHeight,
      int visibleWidth,
      final GeneratedModelSuffixView object) {
  ...
  public GeneratedModelSuffixViewSuffix_ onVisibilityChanged(
      OnModelVisibilityChangedListener<GeneratedModelSuffixViewSuffix_, GeneratedModelSuffixView>
          listener) {
    onMutation();
  ...
  @Override
  public GeneratedModelSuffixViewSuffix_ id(
  ...
  public String toString() {
    return "GeneratedModelSuffixViewSuffix_{" + "}" + super.toString();
  }
