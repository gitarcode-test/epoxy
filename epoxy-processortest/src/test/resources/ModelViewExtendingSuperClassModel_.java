...
public class ModelViewExtendingSuperClassModel_ extends EpoxyModel<ModelViewExtendingSuperClass>
    implements GeneratedModel<ModelViewExtendingSuperClass>,
        ModelViewExtendingSuperClassModelBuilder {
  private OnModelBoundListener<ModelViewExtendingSuperClassModel_, ModelViewExtendingSuperClass>
      onModelBoundListener_epoxyGeneratedModel;

  private OnModelUnboundListener<ModelViewExtendingSuperClassModel_, ModelViewExtendingSuperClass>
      onModelUnboundListener_epoxyGeneratedModel;

  private OnModelVisibilityStateChangedListener<
          ModelViewExtendingSuperClassModel_, ModelViewExtendingSuperClass>
  ...
  public void handlePreBind(
      final EpoxyViewHolder holder, final ModelViewExtendingSuperClass object, final int position) {
  ...
  public ModelViewExtendingSuperClassModel_ onBind(
      OnModelBoundListener<ModelViewExtendingSuperClassModel_, ModelViewExtendingSuperClass>
          listener) {
    onMutation();
  ...
  public ModelViewExtendingSuperClassModel_ onUnbind(
      OnModelUnboundListener<ModelViewExtendingSuperClassModel_, ModelViewExtendingSuperClass>
          listener) {
    onMutation();
  ...
  public void onVisibilityStateChanged(
      int visibilityState, final ModelViewExtendingSuperClass object) {
  ...
  @Override
  public ModelViewExtendingSuperClassModel_ id(
