...
public class ModelWithConstructors_ extends ModelWithConstructors
    implements GeneratedModel<Object>, ModelWithConstructorsBuilder {
  ...
  private OnModelVisibilityStateChangedListener<ModelWithConstructors_, Object>
      onModelVisibilityStateChangedListener_epoxyGeneratedModel;

  private OnModelVisibilityChangedListener<ModelWithConstructors_, Object>
  ...
  @Override
  public ModelWithConstructors_ id(
  ...
  public String toString() {
    return "ModelWithConstructors_{" + "valueInt=" + valueInt + "}" + super.toString();
  }
}
