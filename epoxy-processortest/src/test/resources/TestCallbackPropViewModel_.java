...
public class TestCallbackPropViewModel_ extends EpoxyModel<TestCallbackPropView>
    implements GeneratedModel<TestCallbackPropView>, TestCallbackPropViewModelBuilder {
  private OnModelBoundListener<TestCallbackPropViewModel_, TestCallbackPropView>
      onModelBoundListener_epoxyGeneratedModel;

  private OnModelUnboundListener<TestCallbackPropViewModel_, TestCallbackPropView>
      onModelUnboundListener_epoxyGeneratedModel;

  private OnModelVisibilityStateChangedListener<TestCallbackPropViewModel_, TestCallbackPropView>
      onModelVisibilityStateChangedListener_epoxyGeneratedModel;

  private OnModelVisibilityChangedListener<TestCallbackPropViewModel_, TestCallbackPropView>
      onModelVisibilityChangedListener_epoxyGeneratedModel;

  @Nullable private View.OnClickListener listener_OnClickListener = (View.OnClickListener) null;
  ...
  public void handlePreBind(
      final EpoxyViewHolder holder, final TestCallbackPropView object, final int position) {
  ...
  public TestCallbackPropViewModel_ onVisibilityStateChanged(
      OnModelVisibilityStateChangedListener<TestCallbackPropViewModel_, TestCallbackPropView>
          listener) {
    onMutation();
  ...
  public void onVisibilityChanged(
      ...
      int visibleHeight,
      int visibleWidth,
      final TestCallbackPropView object) {
  ...
  public TestCallbackPropViewModel_ listener(
      @Nullable
          final OnModelClickListener<TestCallbackPropViewModel_, TestCallbackPropView> listener) {
    onMutation();
    if (listener == null) {
  ...
  @Override
  public TestCallbackPropViewModel_ id(
