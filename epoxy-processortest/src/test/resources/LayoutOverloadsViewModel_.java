...
public class LayoutOverloadsViewModel_ extends EpoxyModel<LayoutOverloadsView>
    implements GeneratedModel<LayoutOverloadsView>, LayoutOverloadsViewModelBuilder {
  private OnModelBoundListener<LayoutOverloadsViewModel_, LayoutOverloadsView>
      onModelBoundListener_epoxyGeneratedModel;

  private OnModelUnboundListener<LayoutOverloadsViewModel_, LayoutOverloadsView>
      onModelUnboundListener_epoxyGeneratedModel;

  private OnModelVisibilityStateChangedListener<LayoutOverloadsViewModel_, LayoutOverloadsView>
      onModelVisibilityStateChangedListener_epoxyGeneratedModel;

  private OnModelVisibilityChangedListener<LayoutOverloadsViewModel_, LayoutOverloadsView>
  ...
  public void handlePreBind(
      final EpoxyViewHolder holder, final LayoutOverloadsView object, final int position) {
  ...
  public LayoutOverloadsViewModel_ onVisibilityStateChanged(
      OnModelVisibilityStateChangedListener<LayoutOverloadsViewModel_, LayoutOverloadsView>
          listener) {
    onMutation();
  ...
  public void onVisibilityChanged(
      ...
      int visibleHeight,
      int visibleWidth,
      final LayoutOverloadsView object) {
  ...
  @Override
  public LayoutOverloadsViewModel_ id(
  ...
  public String toString() {
    return "LayoutOverloadsViewModel_{" + "}" + super.toString();
  }
