...
public class SourceViewModel_ extends AirEpoxyModel<SourceView>
  ...
  public int hashCode() {
    ...
    _result =
        31 * _result
            + (getShowDividerWithSetter() != null ? getShowDividerWithSetter().hashCode() : 0);
    return _result;
  }
  ...
  public String toString() {
    return "SourceViewModel_{"
        ...
        + ", baseViewProp_Int="
        + baseViewProp_Int
        + ", baseViewPropWithDefaultParamValue_Int="
        + baseViewPropWithDefaultParamValue_Int
        + ", showDivider="
        + getShowDivider()
        + ", showDividerWithSetter="
        + getShowDividerWithSetter()
        + "}"
        + super.toString();
  }
