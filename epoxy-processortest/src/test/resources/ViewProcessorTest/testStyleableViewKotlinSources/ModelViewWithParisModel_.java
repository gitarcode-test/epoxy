...
public class ModelViewWithParisModel_ extends EpoxyModel<ModelViewWithParis>
    implements GeneratedModel<ModelViewWithParis>, ModelViewWithParisModelBuilder {
  private static final Style DEFAULT_PARIS_STYLE =
      new ModelViewWithParisStyleApplier.StyleBuilder().addDefault().build();
  ...
  private OnModelBoundListener<ModelViewWithParisModel_, ModelViewWithParis>
      onModelBoundListener_epoxyGeneratedModel;

  private OnModelUnboundListener<ModelViewWithParisModel_, ModelViewWithParis>
      onModelUnboundListener_epoxyGeneratedModel;

  private OnModelVisibilityStateChangedListener<ModelViewWithParisModel_, ModelViewWithParis>
      onModelVisibilityStateChangedListener_epoxyGeneratedModel;

  private OnModelVisibilityChangedListener<ModelViewWithParisModel_, ModelViewWithParis>
  ...
  public void handlePreBind(
      final EpoxyViewHolder holder, final ModelViewWithParis object, final int position) {
            ...
            public void run() {
              try {
                StyleApplierUtils.Companion.assertSameAttributes(
                    new ModelViewWithParisStyleApplier(object), style, DEFAULT_PARIS_STYLE);
              } catch (AssertionError e) {
                throw new IllegalStateException(
                    "ModelViewWithParisModel_ model at position "
                        + position
  ...
  public ModelViewWithParisModel_ onVisibilityStateChanged(
      OnModelVisibilityStateChangedListener<ModelViewWithParisModel_, ModelViewWithParis>
          listener) {
    onMutation();
  ...
  public void onVisibilityChanged(
      ...
      int visibleHeight,
      int visibleWidth,
      final ModelViewWithParis object) {
  ...
  public ModelViewWithParisModel_ styleBuilder(
    ...
    ModelViewWithParisStyleApplier.StyleBuilder builder =
        new ModelViewWithParisStyleApplier.StyleBuilder();
  ...
  @Override
  public ModelViewWithParisModel_ id(
