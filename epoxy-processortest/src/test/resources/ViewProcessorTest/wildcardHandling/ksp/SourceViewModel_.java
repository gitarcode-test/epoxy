...
public class SourceViewModel_ extends EpoxyModel<SourceView>
  ...
  @Nullable
  private KeyedListener<?, View.OnClickListener> keyedListener_KeyedListener =
      (KeyedListener<?, View.OnClickListener>) null;
